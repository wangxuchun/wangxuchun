<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">事业法人单位建立党的基层组织情况</h3>
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td width="2000" style="height: 100px;" colspan=4 rowspan=2>项目</td>
                    <td style="border-right: none;border-bottom: none;" colspan=2></td>
                    <td colspan=10 style="height: 22px"></td>
                </tr>
                <tr>
                    <td colspan="2" style="border-left: none;height: 78px;">总数</td>
                    <td width="80">农业</td>
                    <td width="80">科学研究</td>
                    <td width="80">普通高等学校</td>
                    <td width="80">中等学校</td>
                    <td width="80">小学校</td>
                    <td width="80">幼儿园</td>
                    <td width="80">卫生</td>
                    <td width="80">新闻出版广电</td>
                    <td width="80">文化艺术</td>
                    <td width="80">体育</td>
                </tr>
                ...
                <tr>
                   <td colspan=4>甲</td>
                   <td colspan="2" width="80"style="height:26px;"><strong>A</strong></td>
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td  class="justify" colspan=4 v-if="item.type == 1">{{item.label}}</td>

                    <td  class="justify" rowspan="3" width="40" v-if="item.type == 2">{{item.title}}</td>
                    <td  class="justify" colspan="3" v-if="item.type == 2">{{item.label}}</td>

                    <td  class="justify" style="border-left: none;" colspan="3" v-if="item.type == 3">{{item.label}}</td>

                    <td  class="justify" style="border-right: none;border-bottom:none;" v-if="item.type == 4">{{item.title}}</td>
                    <td  class="justify" style="border-left: none;" colspan="3" v-if="item.type == 4">{{item.label}}</td>

                    <td  class="justify" style="border-top: none" rowspan="2" v-if="item.type == 5">{{item.title}}</td>
                    <td  class="justify" style="" colspan="3" v-if="item.type == 5">{{item.label}}</td>

                    <td  class="justify" style="border-left: none;" colspan="3" v-if="item.type == 6">{{item.label}}</td>


                    <td  class="justify" style="" rowspan="4" v-if="item.type == 7">{{item.title}}</td>
                    <td  class="justify" style="border-left: none;border-right: none;border-bottom: none;" width="40" v-if="item.type == 7"></td>
                    <td  class="justify" style="border-left: none;" colspan="2" width="40" v-if="item.type == 7">{{item.label}}</td>

                    <td  class="justify" style="border-left: none;border-right: none;" width="40" v-if="item.type == 8"></td>
                    <td  class="justify" style="border-left: 1px solid #222;" colspan="2" width="40" v-if="item.type == 8">{{item.label}}</td>
                    <td  class="justify" style="border-left: none;" colspan="3" width="40" v-if="item.type == 9">{{item.label}}</td>

                    <td  class="justify" style="" rowspan="4" width="40" v-if="item.type == 10">{{item.title}}</td>
                    <td  class="justify" style="border-left: none;border-right:none;border-bottom:none;"  width="40" v-if="item.type == 10"></td>
                    <td  class="justify" style="" colspan="2" width="40" v-if="item.type == 10">{{item.label}}</td>

                    <td  class="justify" style="border-left: none;border-right:none;border-bottom:none;"  width="40" v-if="item.type == 11"></td>
                    <td  class="justify" style="border-left: 1px solid #222;" colspan="2" width="30" v-if="item.type == 11">{{item.label}}</td>

                    <td  class="justify" style="border-left: none;border-bottom: none;border-right: none;" width="20" v-if="item.type == 12"></td>
                    <td  class="justify" style="border-left: 1px solid #222;border-bottom: none;border-right:1px solid #222;" width="20" v-if="item.type == 12"></td>
                    <td  class="justify" style="" v-if="item.type == 12">{{item.label}}</td>

                    <td  class="justify" style="border-left: none;border-top: none;border-right: none;"  width="20" v-if="item.type == 13"></td>
                    <td  class="justify" style="border-right:1px solid #222;border-left: 1px solid #222" width="20" v-if="item.type == 13"></td>
                    <td  class="justify" style="" v-if="item.type == 13" width="80">{{item.label}}</td>



                    <td  width=30 style="font-weight: bold;">{{index+1}}</td>

                    <td v-for="(inner, inx) in item.lists" v-if="inx<=10" width="50">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 ) ? '#a1d8ff' : (index > 1 && inx == 6) ? '#ffd4bc' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor':  (index == 0 ) ? '#a1d8ff' : (index > 1 && inx == 6) ? '#ffd4bc' : '' }">
                    </td>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '单位数',  disabled: false, calc: 'for(let i=0;i<11;i++){let tp1=this.origin[1].lists[i].value==""?0:this.origin[1].lists[i].value;let tp2=this.origin[2].lists[i].value==""?0:this.origin[2].lists[i].value;let tp3=this.origin[3].lists[i].value==""?0:this.origin[3].lists[i].value;let tp4=this.origin[4].lists[i].value==""?0:this.origin[4].lists[i].value;let tp5=this.origin[7].lists[i].value==""?0:this.origin[7].lists[i].value;let tp6=this.origin[9].lists[i].value==""?0:this.origin[9].lists[i].value;let tp7=this.origin[10].lists[i].value==""?0:this.origin[10].lists[i].value;this.origin[0].lists[i].value=parseInt(tp1)+parseInt(tp2)+parseInt(tp3)+parseInt(tp4)+parseInt(tp5)+parseInt(tp6)+parseInt(tp7)}', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 2,title: '已单独建立党组织', label: '建立党委的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 3,title: '', label: '建立总支部的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 3,title: '', label: '建立支部的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},

                    {type: 4,title: '', label: '已建立联合党支部的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},

                    {type: 5,title: '', label: '具有3名以上党员的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 6,title: '', label: '联合党支部数',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},

                    {type: 7,title: '未建立党组织', label: '应建尚未建立党组织的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 8,title: '', label: '建立党小组的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 9,title: '', label: '仅有个别党员的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 9,title: '', label: '没有党员的',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},

                    {type: 10,title: '补充情况', label: '在岗职工',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 11,title: '', label: '党员',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
                    {type: 12,title: '', label: '专业技术人员',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},

                    {type: 13,title: '', label: '党员',  disabled: false, calc: '', bgcolor: "#222", lists: [{disabled: true,value: 4},{disabled: true,value:7},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67},{disabled: true,value:67}]},
