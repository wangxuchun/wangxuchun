        ...
        <Form :label-width="0" ref="infoForm" :model="infoForm" :rules="ruleValidate">
            <div v-if="infoForm.deleteflag=='0'||infoForm.deleteflag==''">
                ...
                <Row>
                    ...
                    <Col span="12">
                        <FormItem class="reset-style" label="入党类型" prop="join_source_list">
                            <Cascader :render-format="renders" change-on-select :transfer=true :disabled="disabledData.join_source < 0" :data="join_source_list" v-model="infoForm.join_source"></Cascader>
                        </FormItem>
                    </Col>
                ...
                <Row>
                    <Col span="12">
                        <FormItem class="reset-style" label="转正日期" prop='join_party_date'>
                            <DatePicker :transfer=true :disabled="disabledData.join_party_date < 0" type="date" v-model="infoForm.join_party_date" placeholder="选择日期" style="width: 100%"></DatePicker>
                        </FormItem>
                    </Col>
                    <Col span="12">
