        ...
        <div class="info-detail box-flex">
          ...
          <Row>
            <div class="tabs">
              ...
              <table>
                <thead>
                  <th style="font-weight: 700;">姓名</th>
                  <th style="font-weight: 700;">职务名称</th>
                  <th style="font-weight: 700;">批准任职日期</th>
                  ...
                  <draggable :list="listData" :element="'tbody'">
                    <tr v-show="listData.length" :class="sortClassName" v-for="(item,index) in listData" :key="item.index" :ondragstart="isDragstart" >
                      ...
                      <td><!-- <Button type="info" size="small" @click="check(item)">查看</Button> --> <Button type="info" size="small" @click="edit(item)">编辑</Button> <Button @click="remove(item,index)" type="error" size="small">删除</Button></td>
                    </tr>
                  </draggable>
              </table>
