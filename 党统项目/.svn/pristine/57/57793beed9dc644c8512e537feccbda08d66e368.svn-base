<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">党的地方委员会换届和领导班子召开民主生活会情况</h3>
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0>
                  ...
                  <tr v-for="(item,index) in tablesData">
                    ...
                    <td width="60" v-for="(inner, inx) in item.lists" v-if="inx<16" style="height: 100px;">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0) ? '#a1d8ff' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0) ? '#a1d8ff' : '' }">
                    </td>
                  </tr>
              </table>
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex">
                    <p>
                        本表A1栏中包括建立工委的城市街道
                        <input class="bg-class3" type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[0].value">个，   已召开民主生活会的
                        <input class="bg-class3" type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[1].value">个，参加人员
                        <input class="bg-class3" type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[2].value">名。
                    </p>
                </div>
            </div>
        </div>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '单位数', calc: 'for(let i=0;i<16;i++){let tp1=this.origin[1].lists[i].value==""?0:this.origin[1].lists[i].value;let tp2=this.origin[2].lists[i].value==""?0:this.origin[2].lists[i].value;let tp3=this.origin[3].lists[i].value==""?0:this.origin[3].lists[i].value;this.origin[0].lists[i].value=parseInt(tp1)+parseInt(tp2)+parseInt(tp3)}', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '省（区 、市）委', calc: '', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '市（州）委', calc: '', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '县（市、区、旗）委', calc: '', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3}]},
