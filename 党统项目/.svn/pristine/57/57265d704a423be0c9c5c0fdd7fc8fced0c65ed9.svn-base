        ...
        <Row>
            <Col span="12">
                ...
                <FormItem label="党代表级别" style="width: 100%;" prop="level">
                    <Select v-model="memberinfo.level" placeholder="请选择" style="width: 61%;">
                ...
                <FormItem label="党代表类型" style="width: 100%;" prop="type">
                    <Select v-model="memberinfo.type" placeholder="请选择" style="width: 61%;">
                      <Option v-for="(item,index) in type_list" :key="item.id" :value="item.id">{{item.name}}</Option>
                    </Select>
                </FormItem>
                
                 <FormItem label="结束日期：" prop="end_time">
                    <DatePicker type="date"  v-model="memberinfo.end_time" placeholder="选择日期" style=""></DatePicker>
                </FormItem>
            </Col>
        </Row>
      </Form>
