<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center">国务院和地方政府工作部门法人单位建立党组织情况</h3>
            ...
            <div class="start-box">
              <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      ...
                      <td width="184">国务院部（委、办、局）</td>
                      <td width="184">省（区、市）政府工作部门 </td>
                      <td width="184">市（地、州、盟）政府工作部门 </td>
                      <td width="184"> 县（市、区、旗）政府工作部门 </td>
                  </tr>
                  <tr>
                     <td height="50">甲</td>
                  ...
                  <tr v-for="(item,index) in tablesData1">
                    ...
                    <td width="80" v-for="(inner, inx) in item.lists" v-if="inx<5">
                        <input type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (inx == 0 || index==0) ? '#a1d8ff' :  '#ffd4bc' }">
		...
		data() {
			return {
                ...
                tablesData: [
                    ...
                    {type: 2,title: '', label: '建立党组的', calc: 'let temp = 0;for (let i = 1; i < 5; i++) {let tp = this.origin[1].lists[i].value == "" ? 0 : this.origin[1].lists[i].value; temp += parseInt(tp)};this.origin[1].lists[0].value = temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '建立党委的', calc: 'let temp = 0;for (let i = 1; i < 5; i++) {let tp = this.origin[2].lists[i].value == "" ? 0 : this.origin[2].lists[i].value; temp += parseInt(tp)};this.origin[2].lists[0].value = temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '建立总支部的', calc: 'let temp = 0;for (let i = 1; i < 5; i++) {let tp = this.origin[3].lists[i].value == "" ? 0 : this.origin[3].lists[i].value; temp += parseInt(tp)};this.origin[3].lists[0].value = temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '建立支部的', calc: 'let temp = 0;for (let i = 1; i < 5; i++) {let tp = this.origin[4].lists[i].value == "" ? 0 : this.origin[4].lists[i].value; temp += parseInt(tp)};this.origin[4].lists[0].value = temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 2,title: '', label: '未建立党组织的', calc: 'let temp = 0;for (let i = 1; i < 5; i++) {let tp = this.origin[5].lists[i].value == "" ? 0 : this.origin[5].lists[i].value; temp += parseInt(tp)};this.origin[5].lists[0].value = temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3}]},
                ],
