<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center">预备党员转正情况</h3>
              ...
              <table align=center cellspacing=0 cellpadding=0>
                  ...
                  <tr v-for="(item,index) in tablesData1">
                    ...
                    <td width="112" v-for="(inner, inx) in item.lists">
                        <input type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (inx == 0 || inx == 1) ? '#a1d8ff' : (index == 0 && inx == 4) ? '#ffd4bc' : '' }">
                    </td>
