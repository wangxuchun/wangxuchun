            ...
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td v-for="(inner, inx) in item.lists">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 1 || index == 2 || index == 10 || inx == 0) ? '#a1d8ff' : (index == 9 || index == 16 || index == 18) ? '#ffd4bc' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 1 || index == 2 || index == 10 || inx == 0) ? '#a1d8ff' : (index == 9 || index == 16 || index == 18) ? '#ffd4bc' : '' }">
                    </td>
