<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">发展对象情况</h3> 
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td width="140" colspan=3 rowspan=3>项目</td>
                    <td style="border-right: none;border-bottom: none;" colspan=2></td>
                    <td style="border-right: none;" colspan=9></td>
                </tr>
                <tr>
                    <td style="border-left:none;width:60px;" rowspan=2 colspan=2>总数</td>
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td v-for="(inner, inx) in item.lists">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 1 || index == 2 || index == 10 ) && inner.value != '--' ? '#a1d8ff' : (index == 9 || index == 16 || index == 18) && inner.value != '--' ? '#ffd4bc' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 1 || index == 2 || index == 10)  && inner.value != '--' ? '#a1d8ff' : (index == 9 || index == 16 || index == 18) && inner.value != '--' ? '#ffd4bc' : '' }">
                    </td>
            ...
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex">
                    <p>截至2016年底，共有农民工发展对象<input type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[0].value" class="yellow">名，其中女性<input type="text" class="yellow" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[1].value">名，35岁及以下的<input type="text" class="yellow" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[2].value">名，大专及以上学历的<input type="text" :disabled="footerVal[3].disabled" :style="{color: footerVal[3].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[3].value" class="yellow">名。</p>  
                </div>
            </div>
        </div>
