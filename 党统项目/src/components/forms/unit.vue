        ...
        <div class="info-detail box-flex">
          ...
          <Row>
            <div class="tabs">
              <table>
                <thead>
                  <th style="font-weight: 700;" width="260">单位名称</th>
                  <th style="font-weight: 700;" width="120">单位性质类别</th>
                  <th style="font-weight: 700;" width="120">法人单位标识</th>
                  <th style="font-weight: 700;" width="185">法人单位建立基层组织情况</th>
                  <th>操作</th>
                </thead>
                <draggable :list="listData" :element="'tbody'">
                  <tr :class="sortClassName" v-for="(item,index) in listData" :key="item.index" :ondragstart="isDragstart" >
                    ...
                    <td width="120px"><Button @click="remove(item,index)" type="error" size="small">删除</Button></td>
                  </tr>
                </draggable>
              </table>
            </div>
