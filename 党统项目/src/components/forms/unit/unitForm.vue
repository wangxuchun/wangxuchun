<template>
    <div class="box-flex start-box box-orient">
        <div class="info-detail box-flex">
              ...
              <Form ref="unitManageForm" :model="unitManageForm" :rules="ruleValidate" label-position="right" :label-width="0">
                  <Row :gutter="16" class="unit-style">
                    <Col span="12">
                      <FormItem class="reset-style" label="类型:" prop="org_type">
                          <Select v-model="unitManageForm.org_type" :disabled="isDisable" placeholder="请选择" :clearable="true">
                      ...
                      <FormItem class="reset-style" label="单位性质类别:" prop="prop_id">
                          <Cascader :render-format="renders" :disabled="isDisable" :data="prop_module" v-model="unitManageForm.prop_id"></Cascader>
                      </FormItem>
                      <FormItem class="reset-style" label="所属行业:" prop="belong_type" >
                          <Cascader :render-format="renders" :disabled="isDisable" :data="belong_module" v-model="unitManageForm.belong_type"></Cascader>
                      </FormItem>
                      <FormItem class="reset-style" label="企业类型:" prop="prop_type">
                          <Cascader :render-format="renders" :disabled="isDisable" :data="prop_moudle" v-model="unitManageForm.prop_type"></Cascader>
                      </FormItem>
                    ...
                    <Col span="12">
                      <FormItem style="margin-top: 80px;" class="reset-style" label="单位隶属关系:" prop="type_id">
                          <Cascader :render-format="renders" :disabled="isDisable" :data="type_module" v-model="unitManageForm.type_id"></Cascader>
                      </FormItem>

                      <FormItem  v-if="unitManageForm.prop_id[unitManageForm.prop_id.length-1]=='1008' || unitManageForm.prop_id[unitManageForm.prop_id.length-1]=='1009'" class="reset-style" label="事业单位类型:" prop="ei_org_type">
                     ...
                     <!--  <FormItem v-if="unitManageForm.prop_id[unitManageForm.prop_id.length-1]=='1008' || unitManageForm.prop_id[unitManageForm.prop_id.length-1]=='1009'"  class="reset-style" label="事业单位类型:" prop="ei_org_type ">
                      ...
                      <FormItem class="reset-style" label="经济类型:" prop="economic_type">
                          <Cascader :render-format="renders" :disabled="isDisable" :data="economic_moudle" v-model="unitManageForm.economic_type"></Cascader>
                      </FormItem>
                      <FormItem class="reset-style" label="企业规模:" prop="scope">
                          <Cascader :render-format="renders" :disabled="isDisable" :data="scope_module" v-model="unitManageForm.scope"></Cascader>
                      </FormItem>
                      ...
                      <FormItem class="reset-style" label="在岗职工技术人员数:" prop="number_artisan">
                          <Input v-model="unitManageForm.number_artisan " :disabled="isDisable" placeholder="请输入在岗职工技术人员数"></Input>
                      </FormItem>
                    </Col>
                  </Row>
                  ...
                  <Row :gutter="16" class="unit-style" >
                    <Col span="12">
                      ...
                      <FormItem class="reset-style" label="单位统一社会信用代码:" prop="orgcode">
                          <Input v-model="unitManageForm.orgcode  " :disabled="isDisable" placeholder="请输入社会信用代码"></Input>
                      </FormItem>
                      <FormItem class="reset-style" label="政府部门建立党组织情况:" prop="org_depts">
                          <Select v-model="unitManageForm.org_depts" :disabled="isDisable" placeholder="请选择" :clearable="true">
                      ...
                      <FormItem class="reset-style" label="建立党员服务机构标识:" prop="if_party_service">
                          <Select v-model="unitManageForm.if_party_service" :disabled="isDisable" placeholder="请选择" :clearable="true">
                              <Option value="1">是</Option>
                              <Option value="2">否</Option>
                          </Select>
                      </FormItem>
                      <FormItem class="reset-style" label="农村专业合作组织标识:" prop="if_teamwork">
                          <Select v-model="unitManageForm.if_teamwork" :disabled="isDisable" placeholder="请选择" :clearable="true">
                              <Option value="1">是</Option>
                              <Option value="2">否</Option>
                          </Select>
                      </FormItem>
                  ...
                  <Row>
                      <Col span="24">
                          ...
                          <FormItem class="reset-style" label="党建指导员姓名:" prop="">
                              ...
                              <Select v-model="model10" disabled  multiple placeholder="请选择" :clearable="true">
                                  <Option v-for="item in insList" :value="item.uid" :key="item.uid">{{item.real_name}}</Option>
                              </Select>
                          </FormItem>
                          <div class="add-member" @click="addTeacher" style="color: #d73826;float: right;;text-align: right;margin-right: 16px;;cursor: pointer;font-size: 14px">
                              <Icon type="android-add"></Icon><span  style="margin-left: 6px;">添加</span>
                          </div>
                      </Col>
                  </Row>
                  <Row>
                      <Col span="12">
                          ...
                          <p style="font-weight: bold;">社会组织</p>
                          <div class="" v-if="unitManageForm.prop_id[unitManageForm.prop_id.length-1]=='1019'">
                            <FormItem  class="reset-style" label="民办非企业单位类型:" prop="private_org_type">
                                <Select placement="top" v-model="unitManageForm.private_org_type" :disabled="isDisable" placeholder="请选择" :clearable="true">
                                    <Option :disabled="item.choosed==0" v-for="item in private_org_module" :key="item.id" :value="item.id">{{item.name}}</Option>
                                </Select>
                            </FormItem>
                          </div>
                          <p style="color: #ccc; margin-top: 10px;" v-if="unitManageForm.prop_id[unitManageForm.prop_id.length-1]!='1019' && unitManageForm.prop_id[unitManageForm.prop_id.length-1]!='1021' ">当【单位性质类别】为【社会组织】时才可填写</p>
                      </Col>
                      <Col span="12">
                          <FormItem style="margin-top: 21px;" class="reset-style" label="法人代表兼任企业党组织书记:" prop="is_dept_leader">
                              <Select v-model="unitManageForm.is_dept_leader" :disabled="isDisable" placeholder="请选择" :clearable="true">
                                  <Option value="1">是</Option>
                                  <Option value="2">否</Option>
                              </Select>
                          </FormItem>
                          <FormItem v-if="unitManageForm.prop_id[unitManageForm.prop_id.length-1]=='1021'" style="margin-top: 30px;" class="reset-style" label="中介组织类型:" prop="mediator_type">
                              <Select :transfer=true placement="top" v-model="unitManageForm.mediator_type" :disabled="isDisable" placeholder="请选择" :clearable="true">
    ...
    export default {
        ...
        data() {
            return {
                ...
                ruleValidate: {
                  org_type:[{
                      required: true, message: '单位名称不能我空', trigger: 'change'
                  }],
                  full_name:[{
