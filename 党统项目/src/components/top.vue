			...
			<div class="top-bar start-box">
				...
				<div class="nav-manage start-box box-align box-flex">
					...
					<div v-for="(item, index) in navData" :key="item.default" :class="{'drown-outer-active': item.active}" class="drown-outer start-box box-align box-pack">
					    ...
					    <!--<div class="drown-outer start-box box-align" :class="{'drown-outer-active': item.active}" v-if="index==4">-->
					    	<!--<router-link :to="{name : 'adminconfig'}">-->
					    		<!--<a style="margin:0 20px; font-size: 16px;">{{item.default}}1112</a>-->
					    	<!--</router-link>-->
					    <!--</div>-->
					</div>
					<!-- <div class="drown-outer start-box box-align box-pack">
						<Dropdown trigger="hover" class="start-box box-align box-pack" style="color:#fff;margin: 0 20px;height: 100%;"  @on-click="routeTo">
					...
					<div class="drown-outer start-box box-align">
						<Dropdown trigger="hover" class="start-box box-align box-pack" style="margin:0 20px; height:100%" @on-click="routeTo">
				...
				<!-- 用户信息 -->
					...
					<!-- <Dropdown class="info-tips" trigger="hover" style="margin:0 20px;" @on-click="setTo">
				        ...
				        <Dropdown-menu slot="list"  class="nav-item text-center" style="padding: 0;" >
				            ...
				            <Dropdown-item name="4"><p style="color:#ed3f14;">退出登录</p></Dropdown-item>
				        </Dropdown-menu>
				    </Dropdown> -->
		...
		data() {
			return {
		        ...
		        navData: [
		        	...
		        	{class: 'drown-outer-active', default: '统计数据', active: false, list: [{name: '党建情况', value: '/baseSituation', active: false},{name: '统计报表', value: '/countForm/covers/form-5?id=', active: false} ]},
