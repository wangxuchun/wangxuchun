<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">党员出党情况(二)</h3> 
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td width="315" colspan=3>项目</td>
                    <td colspan=2>总数</td>
                    <td>开除党籍</td>
                    <td>退党除名</td>
                    <td>劝退</td>
                    <td>劝而不退除名</td>
                    <td class="br0">自行脱党除名</td>
                    <td>取消预备党员资格</td>
                    <td>不予承认</td>
                </tr>
                <tr>
                ...
                <tr width="95" v-for="(item, index) in tablesData">
                    ...
                    <td width="80" v-for="(inner, inx) in item.lists">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || inx == 0) ? '#a1d8ff' : ((inx == 6 || inx == 3 || inx == 4) && index > 7 && index < 14) || (inx == 7 && index == 14) ? '#ffd4bc' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || inx == 0) ? '#a1d8ff' : ((inx == 6 || inx == 3 || inx == 4) && index > 7 && index < 14) || (inx == 7 && index == 14) ? '#ffd4bc' : '' }">
                    </td>
