<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center">留学回国人员党员情况</h3>
        ...
        <div class="table-outer"  style="margin-top:-10px;">
            <div class="start-box">
              <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      <td width="260" height="124" rowspan="2" colspan=2>项目</td>
                      <td width="150" colspan=2 style="border-bottom:none;border-right: none;"></td>
                      <td width="260" colspan="2"></td>
                      <td width="130" rowspan="2">组织关系出国（境）时转往国（境）外的</td>
                  ...
                  <tr>
                      ...
                      <td width="130">组织关系出国（境）时未转往国（境）外的</td>
                      <td width="130">在国（境）外期间与党组织保持联系的</td>
                  </tr>

                  <tr>
                      <td height="50" width="260" colspan=2>甲</td>
	...
	export default {
		...
		data() {
			return {
                msg: 'this is table',
                tablesData: [
                    {type: 1,title: '', label: '总数', calc: 'for(let i=0;i<7;i++){let tp1=this.origin[1].lists[i].value==""?0:this.origin[1].lists[i].value;let tp2=this.origin[2].lists[i].value==""?0:this.origin[2].lists[i].value;if(i<6){this.origin[0].lists[i].value=parseInt(tp1)+parseInt(tp2)}else{this.origin[0].lists[i].value=parseInt(tp1)}}', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3}]},
//
                    {type: 2,title: '', label: '已恢复组织生活的', calc: 'let temp=0;for(let i=1;i<7;i++){let tp=this.origin[1].lists[i].value==""?0:this.origin[1].lists[i].value;if(i!=1&&i!=2&&i!=5){temp+=parseInt(tp)}};this.origin[1].lists[0].value=temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 3,title: '', label: '未恢复组织生活的', calc: 'let temp=0;for(let i=1;i<7;i++){let tp=this.origin[2].lists[i].value==""?0:this.origin[2].lists[i].value;if(i!=1&&i!=2&&i!=5&&i!=6){temp+=parseInt(tp)}};this.origin[2].lists[0].value=temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3}]},
                    {type: 4,title: '', label: '已提出恢复申请的', calc: 'let temp=0;for(let i=1;i<7;i++){let tp=this.origin[3].lists[i].value==""?0:this.origin[3].lists[i].value;if(i!=1&&i!=2&&i!=5&&i!=6){temp+=parseInt(tp)}};this.origin[3].lists[0].value=temp', disabled: false, bgcolor: "#222", lists:[{disabled: false,value: 4},{disabled: false,value:7},{disabled: false,value:67},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3},{disabled: false,value:3}]},
