<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">入党申请人情况</h3> 
            ...
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td v-for="(inner, inx) in item.lists">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 3 || index == 2 || index == 11 ) && inner.value != '--' ? '#a1d8ff' : (index == 11 || index == 17 || index == 19) && inner.value != '--' ? '#ffd4bc' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 3 || index == 2 || index == 11)  && inner.value != '--' ? '#a1d8ff' : (index == 10 || index == 17 || index == 19) && inner.value != '--' ? '#ffd4bc' : '' }">
                    </td>
