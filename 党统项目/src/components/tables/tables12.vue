<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">学生党员情况</h3>
           <p>截至日期：2017年12月31日</p>
        </div>
        
        <div class="start-box box-pack" style="position: relative; top: -16px;">
            <p>填报单位：天房科技党总支</p>
            <p style="float: right;position: absolute;right: 0;">第七表</p>
        </div>
        <div class="table-outer" style="margin-top: -10px;">
                <!--{{tablesData}}-->
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td style="width: 468px;height: 72px;" colspan=3 rowspan=2>项目</td>
                    <td style="border-left:none;border-right: none;width: 80px" rowspan=2 colspan="2">党员总数</td>
                    <td colspan="2" style="border-left: none;height: 24px;;"></td>
                    <td style="border-left:none;border-right: none;width: 160px" rowspan=2>党员总数</td>
                    <td colspan="2" style="border-left: none;"></td>
                </tr>
                <tr>
                    <td width="140">女</td>
                    <td width="140">少数<br>名族</td>
                    <td width="140" style="border-left: 1px solid ;">女</td>
                    <td width="140">少数<br>名族</td>
                </tr>
                <tr>
                    <td colspan="3" style="height: 24px;">甲</td>
                    <td colspan="2">A</td>
                    <td>B</td>
                    <td>C</td>
                    <td>D</td>
                ...
                <tr  v-for="(item, index) in tablesData">
                    ...
                    <td  class="justify" colspan=3 v-if="item.type == 1" style="height: 38px;">{{item.label}}</td>
                    <td  class="justify" rowspan =10 width="48" v-if="item.type == 2">{{item.title}}</td>
                    <td  class="justify" colspan="2" v-if="item.type == 2" style="height: 38px;">{{item.label}}</td>
                    <td  class="justify" style="border-left: none;height: 38px;" rowspan =3 width="48" v-if="item.type == 3">{{item.title}}</td>
                    <td  class="justify"  v-if="item.type == 3" style="border-left: none;height: 38px;">{{item.label}}</td>
                    <td  class="justify"  v-if="item.type == 4" style="border-left: none;height: 38px;" >{{item.label}}</td>

                    <td  class="justify" style="border-left: none;height: 38px;" rowspan =3 width="48" v-if="item.type == 5">{{item.title}}</td>
                    <td  class="justify"  v-if="item.type == 5" style="border-left: none;height: 38px;">{{item.label}}</td>
                    <td  class="justify"  v-if="item.type == 6" style="border-left: none;height: 38px;" >{{item.label}}</td>

                    <td  class="justify"  v-if="item.type == 7" style="border-left: none;height: 38px;" rowspan =3 width="48" >{{item.title}}</td>
                    <td  class="justify"  v-if="item.type == 7" style="border-left: none;height: 38px;">{{item.label}}</td>
                    <td  class="justify"  v-if="item.type == 8" style="border-left: none;height: 38px;" >{{item.label}}</td>

                    <td  class="justify"  v-if="item.type == 9" colspan="3" style="height: 38px;" >{{item.label}}</td>
                    ...
                    <td width=40><strong style="width: 100%;text-align: center;display: block;;">{{index+1}}</strong></td>
                    ...
                    <td v-for="(inner, inx) in item.lists">
                        ...
                        <input type="text"  :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}"   v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (index == 0 || index == 1) ? '#a1d8ff' :  '#f9f9f9'}">
                    </td>
                    <!---->
                </tr>
            </table>
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex">
                    <p>
                        1.全体在校学生中研究生
                        <input type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[0].value" > 人，大学本科生
                        <input type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[1].value" >人，大学专科生
                        <input type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[2].value">人，中专生
                        <input type="text" :disabled="footerVal[3].disabled" :style="{color: footerVal[3].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[3].value">人,高中、中技学生
                        <input type="text" :disabled="footerVal[4].disabled" :style="{color: footerVal[4].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[4].value">人。
                    </p>
                    <p style="margin-top: 10px;line-height: 24px;">
                        2.高等学校共有教师
                        <input type="text" :disabled="footerVal[5].disabled" :style="{color: footerVal[5].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[5].value" > 人，其中女性
                        <input type="text" :disabled="footerVal[6].disabled" :style="{color: footerVal[6].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[6].value" >人，35岁及以下的
                        <input type="text" :disabled="footerVal[7].disabled" :style="{color: footerVal[7].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[7].value">人；共有教师党员
                        <input type="text" :disabled="footerVal[8].disabled" :style="{color: footerVal[8].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[8].value">人,其中女性
                        <input type="text" :disabled="footerVal[9].disabled" :style="{color: footerVal[9].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[9].value">人，35岁及以下的
                        <input type="text" :disabled="footerVal[10].disabled" :style="{color: footerVal[10].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[10].value">人；本年发展教师</p>
                    <p style="margin-top: 10px">党员
                        <input type="text" :disabled="footerVal[11].disabled" :style="{color: footerVal[11].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[11].value">人，其中女性
                        <input type="text" :disabled="footerVal[12].disabled" :style="{color: footerVal[12].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[12].value">人35岁及以下的
                        <input type="text" :disabled="footerVal[13].disabled" :style="{color: footerVal[13].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[13].value">人。
                    </p>
                </div>
            </div>
        </div>
