<template>
    <div class="tables  tables-auto">
        <div class="title text-center">
           <h3 class="text-center">党内表彰情况</h3>
        ...
        <div class="table-outer"  style="margin-top:-10px;">
            <div class="start-box">
              <table align=center cellspacing=0 cellpadding=0>
                  <tr>
                      <td width="360" rowspan=2 style="height:48px;">项目</td>
                      <td class="br0" width="140" colspan=2 rowspan=2>总数</td>
                      <td width="140" style="height:22px;"></td>
                      <td class="bb0" width="140">省（区、市）一级</td>
                      <td class="bb0" width="140">市（地、州、盟）</td>
                      <td class="bb0" width="140">县（市、区、旗）</td>
                      <td width="140" rowspan=2>其他表彰</td>
                  </tr>
                  <tr>
                    <td width="140">抗灾救灾</td>
                    <td width="140">表彰</td>
                    <td width="140">一级表彰</td>
                    <td width="140">一级表彰</td>
                  </tr>
                  <tr>
                     <td height="36">甲</td>
                  ...
                  <tr v-for="(item,index) in tablesData1">
                    ...
                    <td width="80" v-for="(inner, inx) in item.lists">
                        <input type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (inx == 0) ? '#a1d8ff' : (index == 0 && inx == 1) ? '#ffd4bc' : '' }">
                    </td>
            ...
            <div class="tips-outer start-box">
                ...
                <div class="tips box-flex">
                    ...
                    <p>2.本年度表彰的优秀共产党员中生活困难的<input type="text" :disabled="footerVal[2].disabled" :style="{color: footerVal[2].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[2].value">名；表彰的优秀党务工作者中生活困难的<input type="text" :disabled="footerVal[3].disabled" :style="{color: footerVal[3].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[3].value">名。</p>
            
                    <p>3.本年度追授优秀共产党员<input type="text" :disabled="true" :style="{color: footerVal[4].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[4].value">名，其中抗灾救灾追授<input type="text" :disabled="true" :style="{color: footerVal[5].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[5].value">名。</p>
                </div>
            </div>
        </div>
