<template>
    <div class="tables tables-auto">
        <div class="title text-center">
           <h3 class="text-center">民主评议党员情况</h3> 
        ...
        <div class="table-outer" style="margin-top: -10px;">
            <table align=center cellspacing=0 cellpadding=0 width="100%">
                <tr>
                    <td width="315" height="170" colspan=2 rowspan=2>项目</td>
                    <td class="bb0 br0" style="height:22px;" colspan=2></td>
                    <td class="bl0" style="height:22px;"></td>
                    <td rowspan=2>建制村</td>
                    <td rowspan=2>社区（居委会）</td>
                    <td rowspan=2>机关</td>
                    <td rowspan=2>事业单位</td>
                    <td rowspan=2>公有制经济控制企业</td>
                    <td rowspan=2>非公有制经济控制企业</td>
                    <td rowspan=2>社会组织</td>
                    <td rowspan=2>其它</td>
                </tr>
                <tr>
                ...
                <tr width="94" v-for="(item, index) in tablesData">
                    ...
                    <td width="80" v-for="(inner, inx) in item.lists">
                        <input  v-if="inner.disabled"  type="text" :disabled="inner.disabled" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (inx == 0 || index == 6) ? '#a1d8ff' : inx == 8 || inx == 9 || index == 11 ? '#ffd4bc' : '' }">
                        <input v-if="!inner.disabled" type="text" :disabled="inner.newDis" :class="{'yellow2': inner.isYellow}" v-model="inner.value" :style="{'color': inner.disabled ? '#111' : inner.class, 'backgroundColor': (inx == 0 || index == 6) ? '#a1d8ff' : inx == 8 || inx == 9 || index == 11 ? '#ffd4bc' : '' }">
                    </td>
        ...
        <div class="tips-outer start-box">
                ...
                <div class="tips box-flex">
                    <p>本年民主评议党员中，发现党员违反党的纪律线索，通报纪检机关查实开除党籍的<input type="text" :disabled="footerVal[0].disabled" :style="{color: footerVal[0].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[0].value" >名,名，给予其他党的纪律处分的<input type="text" :disabled="footerVal[1].disabled" :style="{color: footerVal[1].class,'backgroundColor':'#ffd4bc'}" v-model="footerVal[1].value">名。</p>
                </div>
            </div>
